...
export default class Chat extends Component {
    ...
    render() {
        ...
        if(this.state.showDialog){
            ...
            <p>Please note: Your 2 snapcoins will be deducted from your wallet and will be transferred to your chat buddy if you wish to proceed. If you buy the product after review suggestion we will give back 10 snapcoins</p>
            <button onClick={() => {
                this.setState({
                    showDialog: false
                })
